...
def main():
    ...
    # Register safe globals used in pruned model serialization
    ...
    if 'complete_model' not in checkpoint:
        raise KeyError("The checkpoint does not contain 'complete_model'. Cannot proceed.")
